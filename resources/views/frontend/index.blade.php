                                            ...
                                            <div class="alert alert-success" role="alert" v-if="st.status == 1">
                                                ...
                                                <div class="text-center">
                                                    <!-- <a :href="'/cetak/'+ st.id"><button class="btn btn-sm btn-primary">
                                                            ...
                                                            CETAK SKL</button></a> -->
                                                    <a v-bind:href="'/i/'+ st.file" v-bind:download="st.name"> <button class="btn btn-sm btn-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-check-fill" viewBox="0 0 16 16">
                                                                <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0zM9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1zm1.354 4.354-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708.708z" />
                                                            </svg>
                                                            Cetak SKL</button></a>
                ...
                <div class="container">
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <ul class="menu menu-gray-600 menu-hover-primary fw-bold fs-6 fs-md-5 order-1 mb-5 mb-md-0">
                            <li class="menu-item">
                                <a href="https://www.instagram.com/smkn2sumedang.official/" target="_blank" class="menu-link px-2">smkn2sumedang.official</a>
                            </li>
